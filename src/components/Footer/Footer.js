...
import elMessageImg from "../../assets/Images/messages.svg"
import elPhone from "../../assets/Images/phone.svg"


function Footer() {
  return (
    <footer className=' mt-[250px] mb-[32px]'>
      <div className="container flex items-start justify-between mx-auto bg-[#F9FFF7] rounded-[16px] pt-[74px] pb-[40px] pl-[62px] pr-[67px]">
        <div className='w-[335px]'>
          <img className='mb-[21px]' src={elsiteLogo} alt="logo" width={207} height={50} />
          <p className='text-[#757575] text-[14px] mb-[33px]'>
          ...
          <IconFooter title={ <svg width="18" height="14" viewBox="0 0 18 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <IconFooter title={<svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <form className='w-[250px]'>
          <strong className='text-[#333333] block mb-[33px]'>Newsletter</strong>
          <p className='text-[#757575] text-[14px] block mb-[20px]'>Get now free 50% discount for alll products on your first order</p>
        <div className='relative'>
        <input className='w-[100%] text-[14px] py-[8px] pl-[16px] pr-[47px] rounded-[10px] outline-none border-black border-[1px]' type="text" placeholder='Your email address'/>
        <button className='absolute py-[7.5px] hover:opacity-60 ease-out transition w-[60px] border-[1px] border-[#8BAC3E] bg-[#8BAC3E] text-white font-semibold rounded-r-[10px] right-0 text-[15px]'>SEND</button>
        </div>
        <div className='flex items-center space-x-[10px] my-[15px]'>
          <img src={elMessageImg} alt="icon" width={15} height={11} />
          <a href=""> elemesid@gmail.com</a>
        </div>
        <div className='flex items-center space-x-[10px]'>
          <img src={elPhone} alt="icon" width={20} height={20} />
          <a href=""> 0888 1111 2222 </a>
        </div>
        </form>
      </div>
      <span className='mx-auto flex justify-center mt-[45px]'>© 2021 Elemes id. All rights reserved</span>
    </footer>
  )
}
